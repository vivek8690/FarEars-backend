...
const { authConfig } = require('../utils/authHelpers');
...
exports.makeAuthentication = async (req, res) => {
	return res.redirect(authConfig.urlGoogle());
};
...
exports.registerUser = async (req, res) => {
	if (req.query.error) {
		...
		const oauth2Client = new google.auth.OAuth2(
			authConfig.googleConfig.clientId,
			authConfig.googleConfig.clientSecret,
			authConfig.googleConfig.redirect
		);
